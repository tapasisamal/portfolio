const projects = [
  {
    ...
    description:
      "A real-time chat application with authentication and live messaging using Supabase real-time database. Users can sign up, log in, and communicate instantly in a shared global chat room.",
